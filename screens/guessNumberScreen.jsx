...
export default () => {
    ...
    const confirmHandler = () => {
        if (isNaN(enteredText) || enteredText <= 0 || enteredText > 99) {
            Alert.alert('Invalid Number!', 'Please enter a value between 1 and 99', [{ text: 'okay', style: 'destructive', onPress: resetHandler }])
            setConfirmedInput();
            return;
        }
    ...
    return (<View style={styles.screen}>
        ...
        <Card>
            ...
            <Input style={styles.inputText} keyboardType="number-pad" maxLength={2} blurOnSubmit={true}
                onChangeText={inputTextHandler}
                textAlign="center"
                value={enteredText}
            />
            <View style={styles.buttonContainer}>
                <View style={styles.button}><Button title="reset" color={Colors.secondary} onPress={resetHandler} /></View>
